...
class KeystoreClient {
   ...
   */
  async save(key: string, value: string, _options?: SecureStore.SecureStoreOptions): Promise<void> {
   ...
   */
  async getValueFor(key: string, _options?: SecureStore.SecureStoreOptions): Promise<string | null> {
   ...
   */
  getValueSync(key: string, _options?: SecureStore.SecureStoreOptions): string | null {
    if (this.isStorageAvailable) {
      try {
   ...
   */
  async delete(key: string, _options?: SecureStore.SecureStoreOptions): Promise<void> {
    if (this.isStorageAvailable) {
      try {
