...
function Slot<T extends React.ElementType>(props: React.ComponentPropsWithRef<T>) {
  ...
  if (children.type === React.Fragment) {
    return <>{React.Children.toArray(childrenProps.children).map((child): any => (React.isValidElement(child) ? Slot({...restOfProps, ref: forwardedRef, children: child}) : child))}</>
  }
...
const Pressable = ({
  ...
  return React.cloneElement<React.ComponentPropsWithoutRef<typeof RNPressable>, React.Component<Omit<RNPressableProps & React.RefAttributes<RNView>, 'ref'>, any, any>>(
...
const View = ({
  ...
  return React.cloneElement<React.ComponentPropsWithoutRef<typeof RNView>, React.ComponentRef<typeof RNView>>(isTextChildren(children) ? <></> : children, {
...
const Text = ({
  ...
  return React.cloneElement<React.ComponentPropsWithoutRef<typeof RNText>, React.ComponentRef<typeof RNText>>(isTextChildren(children) ? <></> : children, {
...
const Image = ({
  ...
  return React.cloneElement<React.ComponentPropsWithoutRef<typeof RNImage>, React.ComponentRef<typeof RNImage>>(isTextChildren(children) ? <></> : children, {
...
export {Image, Pressable, Slot, Text, View}
